<template>
  <article id="AboutMe" class="AboutMe mx-auto max-w-7xl px-4 sm:mt-3 sm:px-6 lg:px-8 mb-4">
    <div class="sectionHead my-2 relative">
      <span class="font-semibold text-sm">
        SOME INFO
      </span>
      <h2 class="font-black text-4xl mt-2">
        ABOUT ME &#128536;
      </h2>
    </div>
